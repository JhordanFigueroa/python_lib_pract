...
y = cases_states['Hawaii'].to_numpy() #transfors into a numpy array just makes an array - don't really need it but its to be consistent 
...
plt.legend()
plt.title("Hawaii COVID-19 data (")
plt.show()